...
import _  from 'lodash';
 ...
 const  App = () => {
    ...
    .map((message) => {
      if(message  && message.data){
        ...
        for(const k in messageData){
          let currentMessageData = messageData[k]
          ...
          message_tickers.push(currentMessageData)
        }
        
        if (tickers && !_.isEqual(tickers, message_tickers)) {
          setTickers(message_tickers)
        }
      }
    })
  ...
  var navClassName = (current_symbol)=> {
    ...
    'border-green-500 bg-green-300 font-bold' :
  ...
  <div>
    ...
    <div className="hidden bg-white-200 md:block md:bg-white-300 md:border-b">
      <div className="container mx-auto px-4">
        <div className="md:flex">
          <div className="flex -mb-px mr-8 items-center self-center">
            <a href="#" className="self-center no-underline text-black md:text-blue-dark flex items-center py-4 border-b border-blue-dark">
  ...
  <div className="flex-grow container mx-auto sm:px-4 pt-6 pb-8">
    <div className="bg-green-200 border-t border-b sm:border-l sm:border-r sm:rounded mb-6">
      <div className="border-b border-green-300">
        <div className="flex justify-between">
          
          <div className="flex">
            <button onClick={()=> { toggleSymbol("BTC-USD")}} type="button" className={`flex appearance-none py-4 border-b  px-10 ${navClassName("BTC-USD")}`}>
              <img className="w-6 mr-2" src="https://img.icons8.com/color/48/000000/bitcoin--v1.png"/> Bitcoin &middot; $21,404.74
            </button>
            <button onClick={()=> { toggleSymbol("ETH-USD")}}  type="button" className={`flex appearance-none py-4 border-b px-10 ${navClassName("ETH-USD")}`}>
              <img className="w-6 mr-2" src="https://img.icons8.com/color/48/000000/ethereum.png"/> Ethereum &middot; $884.80
            </button>
          </div>
